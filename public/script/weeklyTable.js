...
document.addEventListener('click',(e)=>{
    if(e.target.classList.contains('getDetails')){
      //  alert(form.children[1].value)
        axios.get('http://ec2-54-91-147-182.compute-1.amazonaws.com:4000/expense/weekly', {headers:{"authorization": token, "month":form.children[1].value, "week":form.children[3].value}})
